...
export type Labels = Record<string, NestedStringRecord>
...
export const LABELS = {
  ...
  HOMEPAGE: {
    ...
    WHAT_WE_DO: {
      TITLE: "What We Do",
      DESCRIPTION:
        "We are a multidisciplinary team supported by the Ethereum Foundation, focused on developing privacy and scaling solutions for Ethereum.",
    },
    JOIN_OUR_DISCORD: "Join our Discord",
  },
  NEWS_SECTION: {
  ...
  RESEARCH_PAGE: {
    ...
    DESCRIPTION:
      "Our research focuses on developing privacy and scaling solutions for Ethereum.",
    ACTIVE_RESEARCH: "Active Research",
    PAST_RESEARCH: "Past Research",
  },
  PROJECTS_PAGE: {
    ...
    DESCRIPTION:
      "Explore our projects and contribute to the future of Ethereum.",
  },
  WHAT_WE_DO_SECTION: {
    ...
    PRINCIPLES: [
      {
        TITLE: "Open Source",
        DESCRIPTION: [
          "We believe in the power of open source software and its ability to drive innovation.",
      ...
      },
      {
        ...
        DESCRIPTION: [
          "We are committed to advancing the state of the art in privacy and scaling solutions.",
          "Our work is driven by research and experimentation.",
        ],
      },
    ],
  },
