...
export const ProgramPageContent = () => {
  ...
  const howToApply = LABELS.PROGRAMS_PAGE.HOW_TO_APPLY as Record<string, any>
  const coreProgramDescription = LABELS.PROGRAMS_PAGE.CORE_PROGRAM
    .DESCRIPTION as string[]
  const accelerationProgramDescription = LABELS.PROGRAMS_PAGE
    .ACCELERATION_PROGRAM.DESCRIPTION as string[]
  const curriculum = LABELS.PROGRAMS_PAGE.CURRICULUM as Array<{
    TITLE: string
    ITEMS: string[]
  }>
  const coreProgramFaq = LABELS.PROGRAMS_PAGE.CORE_PROGRAM.FAQ as Array<{
    question: string
    answer: string
  }>
  const accelerationProgramFaq = LABELS.PROGRAMS_PAGE.ACCELERATION_PROGRAM
            ...
            <div className="absolute right-0 mt-[80px] flex flex-col gap-4 lg:w-[220px] xl:w-[320px] xl:px-8">
              ...
              <ul className="text-normal font-sans text-black">
                {ProgramSections.map((id: string) => {
                  const label =
                    id === "coreProgram"
                      ? LABELS.PROGRAMS_PAGE.CORE_PROGRAM.TITLE
                      : LABELS.PROGRAMS_PAGE.ACCELERATION_PROGRAM.TITLE
            ...
            <div className="mx-auto flex flex-col md:max-w-2xl">
              <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-0 md:mt-4 md:gap-10">
                  <div className="flex flex-col gap-10">
                    ...
                    <TableRowCard
                      items={curriculum.map(({ TITLE, ITEMS }, index) => ({
                        title: (
                          <span>
                            {LABELS.PROGRAMS_PAGE.COMMON.WEEK.replace(
                              "{{week}}",
                              index.toString()
                            )}
                            <br />
                  ...
                  <div className="flex flex-col">
                    <AccordionLabel label={LABELS.PROGRAMS_PAGE.COMMON.FAQ} />
                    <div className="pt-10">
                      <Accordion
                        id="faq"
          ...
          <div className="flex w-full flex-col">
            ...
            >
              ...
              <div className="flex flex-col gap-0  pt-14 md:gap-10">
                <div className="flex flex-col">
                  <AccordionLabel
                    label={LABELS.PROGRAMS_PAGE.COMMON.HOW_TO_APPLY}
                  />
                  <div className="mt-10">
