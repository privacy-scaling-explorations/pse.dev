...
export const ResourceCard = ({ title, children }: ResourceCardProps) => {
  return (
    <div
...
export default function ResourcePage() {
  return (
    <div className="bg-second-gradient">
      ...
      <div className="container grid gap-8 pb-10 lg:gap-16 md:pb-20">
        <ResourceCard title="Get involved">
          <ResourceItem
            label="PSE Discord"
