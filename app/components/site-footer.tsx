          ...
          <div className="order-2 grid grid-cols-1 justify-between gap-10 uppercase lg:grid-cols-5 lg:gap-0">
            ...
            <LinksWrapper>
              ...
              <Link
                ...
                className="flex items-center gap-2"
              >
                <ItemLabel label={LABELS.MENU.JOBS} external />
              </Link>
              <Link
                ...
                className="flex items-center gap-2"
              >
                <ItemLabel label={LABELS.MENU.REPORT} external />
              </Link>
              <Link
                ...
                className="flex items-center gap-2"
              >
                <ItemLabel label={LABELS.MENU.FIRST_GOOD_ISSUE} external />
              </Link>
            </LinksWrapper>
            <LinksWrapper>
              <Link
            ...
            <LinksWrapper>
              ...
              <Link
                ...
                rel="noreferrer"
              >
                <ItemLabel label={LABELS.FOOTER.PRIVACY_POLICY} />
              </Link>
              <Link
                ...
                rel="noreferrer"
              >
                <ItemLabel label={LABELS.FOOTER.TERMS_OF_USE} />
              </Link>
            </LinksWrapper>
          </div>
        </AppContent>
